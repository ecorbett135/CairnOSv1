...
| 2026-05-19 | Bear-box amenity candidate | Green Mountain Club bear boxes | [GMC bear boxes](https://www.greenmountainclub.org/bear-boxes/) | Official trail organization | Future overnight amenity field and possible user preference for bear-box sites | High for current public page content, subject to change | Medium | Proposed as future roadmap work. If implemented, record collection date and whether values are manually curated. |
